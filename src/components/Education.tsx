      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-semibold tracking-tight">Education</h2>
          </div>
          <p className="text-lg text-muted-foreground">
            MS Financial Engineering candidate with interdisciplinary background in software and chemical engineering
          </p>
        </motion.div>
            ...
            >
              <Card className="h-full p-8 border-border/50 bg-card/50 backdrop-blur hover:border-accent/30 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-xl text-accent mb-3">{edu.field}</p>
                  <p className="text-muted-foreground mb-1">{edu.institution}</p>
                  {edu.location && (
                    <p className="text-sm text-muted-foreground/80 mb-1">{edu.location}</p>
                  )}
