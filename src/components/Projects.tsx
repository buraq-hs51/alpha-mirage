      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Quantitative finance, machine learning, and data engineering projects demonstrating end-to-end technical capabilities
          </p>
                  ...
                  {VisualizationComponent && (
                    <div className="mb-4">
                      ...
                      >
                        ...
                        {isExpanded ? 'Hide Visualization' : 'Show Results Visualization'}
                      </Button>
