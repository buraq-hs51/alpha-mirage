  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          Multidisciplinary technologist with <span className="text-foreground font-medium">4.5 years</span> building production systems across software engineering, data engineering, 
          machine learning, and quantitative finance. Expert in microservices, distributed systems, high-throughput data pipelines 
          (<span className="text-accent font-medium">200TB+ daily</span>), deep learning with TensorFlow/NLP, and ultra-low-latency trading systems.
        </motion.p>
        ...
        >
          ...
          >
            <Button 
              size="lg" 
              variant="ghost" 
              className="text-foreground/70 hover:text-accent group"
              asChild
            >
              <a href="https://www.kickresume.com/cv/4W3LxK/" target="_blank" rel="noopener noreferrer">
                <FileText className="mr-2 group-hover:drop-shadow-[0_0_8px_oklch(0.75_0.18_190)]" weight="duotone" />
                Resume
              </a>
            </Button>
          </motion.div>
