      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-semibold tracking-tight">Technical Skills</h2>
          </div>
          <p className="text-lg text-muted-foreground">
            Comprehensive expertise spanning software engineering, data engineering, machine learning, and quantitative finance—optimized for building production-grade trading systems
          </p>
        </motion.div>
