      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Actively seeking quantitative developer roles globally. Open to opportunities in derivatives pricing, 
            trading systems engineering, and quantitative research. Willing to relocate for the right opportunity.
          </p>
        </motion.div>
        ...
        >
          <div className="inline-flex flex-wrap items-center justify-center gap-6 p-6 rounded-lg bg-muted/30 backdrop-blur">
            <div>
              ...
              <p className="font-medium text-accent">Actively Seeking Opportunities</p>
            </div>
            <div className="h-8 w-px bg-border hidden sm:block"></div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">Location</p>
              <p className="font-medium">Open to Global Relocation</p>
            </div>
            <div className="h-8 w-px bg-border hidden sm:block"></div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">Availability</p>
              <p className="font-medium">Immediate / Flexible</p>
            </div>
          </div>
        </motion.div>
      </div>
